...
set -U fish_user_paths  $HOME/.local/share/nvim/mason/bin/ $HOME/.ghcup/bin $HOME/.cargo/bin $HOME/.local/bin $HOME/bin $HOME/.emacs.d/bin  $fish_user_paths
...
alias configbackup='cp -Rf ~/.config/ ~/config-backup-(date +%Y.%m.%d-%H.%M.%S)'
